...
class BavarianCrops(Dataset):
    def __init__(
        ...
        self.classweights = np.load(
            os.path.join(npy_folder, "classweights.npy"), allow_pickle=True
        )
        self.y = np.load(os.path.join(npy_folder, "y.npy"), allow_pickle=True)
        self.ndims = int(
            np.load(os.path.join(npy_folder, "ndims.npy"), allow_pickle=True)
        )
        self.sequencelengths = np.load(
            os.path.join(npy_folder, "sequencelengths.npy"), allow_pickle=True
        )
